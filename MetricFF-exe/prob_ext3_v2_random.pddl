...
(define (problem prob_ext3_v2_random)
	(:domain domini_ext3)
	(:objects
		r1 r2 - rover
	...
	(:init
		...
		(peticion p3 as8) (= (prioridad-peticion p3 as8) 2) (enBase p3 as9)
		(peticion p4 as2) (= (prioridad-peticion p4 as2) 2) (enBase p4 as5)
		(peticion p5 as5) (= (prioridad-peticion p5 as5) 3) (enBase p5 as7)
		(peticion p6 as1) (= (prioridad-peticion p6 as1) 3) (enBase p6 as8)
		(peticion p7 as7) (= (prioridad-peticion p7 as7) 2) (enBase p7 as10)
		(peticion p8 as9) (= (prioridad-peticion p8 as9) 3) (enBase p8 as6)
		(peticion p9 as2) (= (prioridad-peticion p9 as2) 1) (enBase p9 as4)
		(peticion p10 as5) (= (prioridad-peticion p10 as5) 1) (enBase p10 as6)
		(peticion p2 as6) (= (prioridad-peticion p2 as6) 1)
		(peticion p6 as4) (= (prioridad-peticion p6 as4) 3)
		(peticion p5 as6) (= (prioridad-peticion p5 as6) 1)
		...
		(peticion s3 as1) (= (prioridad-peticion s3 as1) 1) (enBase s3 al5)
		(peticion s4 as1) (= (prioridad-peticion s4 as1) 1) (enBase s4 al2)
		(peticion s5 as1) (= (prioridad-peticion s5 as1) 1) (enBase s5 al3)
		(peticion s6 as3) (= (prioridad-peticion s6 as3) 2) (enBase s6 al4)
		(peticion s7 as2) (= (prioridad-peticion s7 as2) 3) (enBase s7 al2)
		(peticion s8 as4) (= (prioridad-peticion s8 as4) 3) (enBase s8 al4)
		(peticion s8 as6) (= (prioridad-peticion s8 as6) 3)
		(peticion s8 as5) (= (prioridad-peticion s8 as5) 2)
