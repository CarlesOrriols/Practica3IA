...
(define (problem prob_ext3_punt_extra_peticions_1)
	(:domain domini_ext3)
	(:objects
		r1 r2 - rover
	...
	(:init
		...
		(peticion p1 as1) (= (prioridad-peticion p1 as1) 1) (enBase p1 as4)
		(peticion p2 as3) (= (prioridad-peticion p2 as3) 1) (enBase p2 as6)
		(peticion p2 as9) (= (prioridad-peticion p2 as9) 3)
		(peticion p1 as8) (= (prioridad-peticion p1 as8) 2)
		(peticion p2 as10) (= (prioridad-peticion p2 as10) 2)

		;PETICIONS DELS SUBMINISTRES I LES SEVES PRIORITATS
		(peticion s1 as4) (= (prioridad-peticion s1 as4) 1) (enBase s1 al3)
		(peticion s2 as4) (= (prioridad-peticion s2 as4) 3) (enBase s2 al4)
		(peticion s1 as8) (= (prioridad-peticion s1 as8) 2)
		(peticion s2 as9) (= (prioridad-peticion s2 as9) 3)
