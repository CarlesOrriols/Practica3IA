...
(define (problem prob_ext3_punt_extra_peticions_3)
	(:domain domini_ext3)
	(:objects
		r1 r2 - rover
	...
	(:init
		...
		(estacionado r1 al1) (estacionado r2 al3) 
		...
		(peticion p1 as3) (= (prioridad-peticion p1 as3) 1) (enBase p1 as5)
		(peticion p2 as9) (= (prioridad-peticion p2 as9) 3) (enBase p2 as3)
