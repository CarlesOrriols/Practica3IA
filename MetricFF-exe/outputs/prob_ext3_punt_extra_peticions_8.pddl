...
(define (problem prob_ext3_punt_extra_peticions_8)
	(:domain domini_ext3)
	(:objects
		r1 r2 - rover
	...
	(:init
		...
		(estacionado r1 al4) (estacionado r2 as4) 
		...
		(peticion p1 as6) (= (prioridad-peticion p1 as6) 1) (enBase p1 as6)
		(peticion p2 as8) (= (prioridad-peticion p2 as8) 2) (enBase p2 as6)
		(peticion p1 as8) (= (prioridad-peticion p1 as8) 2)
		(peticion p1 as5) (= (prioridad-peticion p1 as5) 2)
		(peticion p1 as2) (= (prioridad-peticion p1 as2) 1)
		(peticion p2 as4) (= (prioridad-peticion p2 as4) 3)
		(peticion p2 as3) (= (prioridad-peticion p2 as3) 2)
		(peticion p1 as3) (= (prioridad-peticion p1 as3) 1)
		(peticion p2 as9) (= (prioridad-peticion p2 as9) 3)
		(peticion p2 as7) (= (prioridad-peticion p2 as7) 3)
		(peticion p2 as5) (= (prioridad-peticion p2 as5) 3)
		(peticion p2 as6) (= (prioridad-peticion p2 as6) 2)

		;PETICIONS DELS SUBMINISTRES I LES SEVES PRIORITATS
		(peticion s1 as1) (= (prioridad-peticion s1 as1) 1) (enBase s1 al4)
		(peticion s2 as4) (= (prioridad-peticion s2 as4) 1) (enBase s2 al3)
		(peticion s1 as2) (= (prioridad-peticion s1 as2) 2)
		(peticion s1 as6) (= (prioridad-peticion s1 as6) 1)
		(peticion s2 as1) (= (prioridad-peticion s2 as1) 3)
		(peticion s2 as9) (= (prioridad-peticion s2 as9) 2)
		(peticion s2 as3) (= (prioridad-peticion s2 as3) 2)
		(peticion s2 as2) (= (prioridad-peticion s2 as2) 1)
		(peticion s2 as6) (= (prioridad-peticion s2 as6) 2)
		(peticion s1 as4) (= (prioridad-peticion s1 as4) 3)
		(peticion s1 as10) (= (prioridad-peticion s1 as10) 1)
		(peticion s1 as3) (= (prioridad-peticion s1 as3) 1)
	)
