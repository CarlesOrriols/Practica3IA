...
(define (problem prob_ext3_punt_extra_recursos_1)
	(:domain domini_ext3)
	(:objects
		r1 r2 - rover
	...
	(:init
		...
		(peticion p3 as9) (= (prioridad-peticion p3 as9) 2) (enBase p3 as9)
		...
		(peticion s2 as3) (= (prioridad-peticion s2 as3) 2) (enBase s2 al3)
		(peticion s3 as4) (= (prioridad-peticion s3 as4) 3) (enBase s3 al2)
		(peticion s3 as8) (= (prioridad-peticion s3 as8) 3)
	)
