...
(define (problem prob_ext3_punt_extra_rovers_1)
	(:domain domini_ext3)
	(:objects
		r1 r2 r3 - rover
	...
	(:init
		...
		(= (suma-prioridades) 12)
		(= (suma-combustible-no-gastado) 150)
		...
		(estacionado r1 as8) (estacionado r2 al3) (estacionado r3 al2) 
		...
		(peticion p1 as5) (= (prioridad-peticion p1 as5) 1) (enBase p1 as8)
		(peticion p2 as9) (= (prioridad-peticion p2 as9) 3) (enBase p2 as7)
		(peticion p1 as3) (= (prioridad-peticion p1 as3) 3)
