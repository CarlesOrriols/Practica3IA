...
(define (problem prob_ext3_punt_extra_peticions_5)
	(:domain domini_ext3)
	(:objects
		r1 r2 - rover
	...
	(:init
		...
		(estacionado r1 al4) (estacionado r2 al1) 
		...
		(peticion p1 as6) (= (prioridad-peticion p1 as6) 1) (enBase p1 as8)
		(peticion p2 as2) (= (prioridad-peticion p2 as2) 3) (enBase p2 as9)
		(peticion p2 as5) (= (prioridad-peticion p2 as5) 3)
		(peticion p1 as7) (= (prioridad-peticion p1 as7) 1)
		(peticion p1 as5) (= (prioridad-peticion p1 as5) 1)
		...
		(peticion p1 as1) (= (prioridad-peticion p1 as1) 2)

		;PETICIONS DELS SUBMINISTRES I LES SEVES PRIORITATS
		(peticion s1 as3) (= (prioridad-peticion s1 as3) 2) (enBase s1 al1)
		(peticion s2 as2) (= (prioridad-peticion s2 as2) 2) (enBase s2 al1)
		(peticion s1 as2) (= (prioridad-peticion s1 as2) 3)
