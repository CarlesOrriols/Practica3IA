...
(define (problem prob_ext3_punt_extra_rovers_4)
	(:domain domini_ext3)
	(:objects
	...
	(:init
		...
		(= (suma-prioridades) 12)
		(= (suma-combustible-no-gastado) 300)
		...
		(estacionado r1 al1) (estacionado r2 as1) (estacionado r3 al1) (estacionado r4 al4) (estacionado r5 al3) (estacionado r6 al3) 
		...
		(peticion p1 as10) (= (prioridad-peticion p1 as10) 1) (enBase p1 as2)
		(peticion p2 as5) (= (prioridad-peticion p2 as5) 1) (enBase p2 as6)
		...
		(peticion s1 as4) (= (prioridad-peticion s1 as4) 3) (enBase s1 al3)
		(peticion s2 as4) (= (prioridad-peticion s2 as4) 2) (enBase s2 al3)
