...
(define (problem prob_ext3_punt_extra_peticions_0)
	(:domain domini_ext3)
	(:objects
		r1 r2 - rover
	...
	(:init
		...
		(peticion p1 as5) (= (prioridad-peticion p1 as5) 2) (enBase p1 as3)
		(peticion p2 as4) (= (prioridad-peticion p2 as4) 3) (enBase p2 as10)
		...
		(peticion s1 as3) (= (prioridad-peticion s1 as3) 3) (enBase s1 al4)
		(peticion s2 as3) (= (prioridad-peticion s2 as3) 1) (enBase s2 al4)
		(peticion s1 as6) (= (prioridad-peticion s1 as6) 2)
		(peticion s2 as7) (= (prioridad-peticion s2 as7) 2)
	)
