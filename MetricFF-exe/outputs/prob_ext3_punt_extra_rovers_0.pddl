...
(define (problem prob_ext3_punt_extra_rovers_0)
	(:domain domini_ext3)
	(:objects
		r1 r2 - rover
	...
	(:init
		...
		(estacionado r1 al5) (estacionado r2 al3) 
		...
		(peticion p1 as8) (= (prioridad-peticion p1 as8) 2) (enBase p1 as2)
		(peticion p2 as7) (= (prioridad-peticion p2 as7) 1) (enBase p2 as8)
		...
		(peticion s1 as3) (= (prioridad-peticion s1 as3) 1) (enBase s1 al1)
		(peticion s2 as1) (= (prioridad-peticion s2 as1) 3) (enBase s2 al1)
