...
(define (problem prob_ext3_punt_extra_peticions_4)
	(:domain domini_ext3)
	(:objects
		r1 r2 - rover
	...
	(:init
		...
		(estacionado r1 as1) (estacionado r2 al1) 
		...
		(peticion p1 as1) (= (prioridad-peticion p1 as1) 1) (enBase p1 as5)
		(peticion p2 as3) (= (prioridad-peticion p2 as3) 1) (enBase p2 as3)
		(peticion p2 as4) (= (prioridad-peticion p2 as4) 3)
		(peticion p1 as4) (= (prioridad-peticion p1 as4) 1)
		(peticion p2 as2) (= (prioridad-peticion p2 as2) 2)
		(peticion p1 as10) (= (prioridad-peticion p1 as10) 1)
		...
		(peticion s1 as4) (= (prioridad-peticion s1 as4) 1) (enBase s1 al4)
		(peticion s2 as1) (= (prioridad-peticion s2 as1) 1) (enBase s2 al1)
		(peticion s1 as2) (= (prioridad-peticion s1 as2) 1)
		(peticion s1 as9) (= (prioridad-peticion s1 as9) 3)
		(peticion s2 as8) (= (prioridad-peticion s2 as8) 2)
		(peticion s2 as4) (= (prioridad-peticion s2 as4) 3)
		(peticion s1 as7) (= (prioridad-peticion s1 as7) 2)
		(peticion s1 as10) (= (prioridad-peticion s1 as10) 3)
	)
