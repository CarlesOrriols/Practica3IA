...
(define (problem prob_ext3_punt_extra_peticions_2)
	(:domain domini_ext3)
	(:objects
		r1 r2 - rover
	...
	(:init
		...
		(estacionado r1 as10) (estacionado r2 as8) 
		...
		(peticion p1 as6) (= (prioridad-peticion p1 as6) 3) (enBase p1 as4)
		(peticion p2 as10) (= (prioridad-peticion p2 as10) 2) (enBase p2 as3)
		(peticion p2 as5) (= (prioridad-peticion p2 as5) 2)
		(peticion p1 as8) (= (prioridad-peticion p1 as8) 3)
		(peticion p1 as4) (= (prioridad-peticion p1 as4) 3)
		(peticion p1 as1) (= (prioridad-peticion p1 as1) 3)

		;PETICIONS DELS SUBMINISTRES I LES SEVES PRIORITATS
		(peticion s1 as3) (= (prioridad-peticion s1 as3) 3) (enBase s1 al1)
		(peticion s2 as1) (= (prioridad-peticion s2 as1) 3) (enBase s2 al2)
		(peticion s1 as5) (= (prioridad-peticion s1 as5) 1)
		(peticion s1 as1) (= (prioridad-peticion s1 as1) 2)
		(peticion s2 as6) (= (prioridad-peticion s2 as6) 1)
